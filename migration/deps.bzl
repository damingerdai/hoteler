...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:O+0C55RbMN66pWm5MjO6mw0px6usGpY0+bkSGW9zCo0=",
        version = "v4.16.1",
    )
    ...
    go_repository(
        ...
        sum = "h1:qzQtHhsZNpVPpeCu+aMIQldXeV1P0vRhSqCL0nOIJOA=",
        version = "v1.16.7",
    )
    ...
    go_repository(
        ...
        sum = "h1:ef66qJSgKeyLyrF4kQ2RHw/Ue3V89fyFNbGL073aDjI=",
        version = "v1.18.0",
    )
