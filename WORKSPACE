...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-graphql:3.5.6",
        "org.springframework.boot:spring-boot-starter-quartz:3.5.6",
        ...
        "org.springframework.boot:spring-boot-loader:3.5.6",
