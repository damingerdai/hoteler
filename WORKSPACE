...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-aop:3.1.2",
        "org.springframework.boot:spring-boot-starter-security:3.1.2",
        "org.springframework.boot:spring-boot-starter-cache:3.1.2",
        "org.springframework.boot:spring-boot-starter-actuator:3.1.2",
        "org.springframework.boot:spring-boot-starter-data-redis:3.1.2",
        "org.springframework.boot:spring-boot-starter-graphql:3.1.2",
        "org.springframework.boot:spring-boot-starter-quartz:3.1.2",
