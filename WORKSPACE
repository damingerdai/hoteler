...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-jdbc:3.5.4",
        "org.springframework.boot:spring-boot-starter-aop:3.5.4",
        "org.springframework.boot:spring-boot-starter-security:3.5.4",
        "org.springframework.boot:spring-boot-starter-cache:3.5.4",
        "org.springframework.boot:spring-boot-starter-actuator:3.5.4",
        "org.springframework.boot:spring-boot-starter-data-redis:3.5.4",
        "org.springframework.boot:spring-boot-starter-graphql:3.5.4",
        "org.springframework.boot:spring-boot-starter-quartz:3.5.4",
        ...
        "org.springframework.boot:spring-boot-loader:3.5.4",
        "org.springframework.boot:spring-boot-loader-tools:3.5.4",
        "io.micrometer:micrometer-registry-prometheus:1.15.2",

        "org.postgresql:postgresql:42.7.7",

        "org.springdoc:springdoc-openapi-starter-webmvc-ui:2.8.11",
        ...
        "org.springframework.boot:spring-boot-devtools:3.5.4",
        "org.springframework.boot:spring-boot-starter-test:3.5.4",
        "org.springframework.security:spring-security-test:6.5.2",
