...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-graphql:3.3.0",
        "org.springframework.boot:spring-boot-starter-quartz:3.3.0",
        ...
        "org.springframework.boot:spring-boot-loader:3.3.0",
        "org.springframework.boot:spring-boot-loader-tools:3.3.0",
