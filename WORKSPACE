...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-aop:3.4.5",
        ...
        "org.springframework.boot:spring-boot-starter-graphql:3.4.5",
        "org.springframework.boot:spring-boot-starter-quartz:3.4.5",
        ...
        "org.springframework.boot:spring-boot-loader:3.4.5",
