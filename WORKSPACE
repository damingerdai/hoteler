...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-graphql:3.3.2",
        "org.springframework.boot:spring-boot-starter-quartz:3.3.2",
        ...
        "org.springframework.boot:spring-boot-loader:3.3.2",
        "org.springframework.boot:spring-boot-loader-tools:3.3.2",
        ...
        "cn.hutool:hutool-crypto:5.8.31",
        ...
        "org.springframework.boot:spring-boot-devtools:3.3.2",
