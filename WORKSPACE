...
http_archive(
    ...
    urls = [
        ...
        "https://mirror.ghproxy.com/https://github.com/salesforce/rules_spring/releases/download/2.3.2/rules-spring-2.3.2.zip",
    ],
)
...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-aop:3.3.1",
        "org.springframework.boot:spring-boot-starter-security:3.3.1",
        "org.springframework.boot:spring-boot-starter-cache:3.3.1",
        "org.springframework.boot:spring-boot-starter-actuator:3.3.1",
        "org.springframework.boot:spring-boot-starter-data-redis:3.3.1",
        "org.springframework.boot:spring-boot-starter-graphql:3.3.1",
        "org.springframework.boot:spring-boot-starter-quartz:3.3.1",
        ...
        "org.springframework.boot:spring-boot-loader:3.3.1",
        "org.springframework.boot:spring-boot-loader-tools:3.3.1",
