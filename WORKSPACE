...
maven_install(
    artifacts = [
        ...
        "org.springframework.boot:spring-boot-starter-jdbc:3.0.5",
        "org.springframework.boot:spring-boot-starter-aop:3.0.5",
        "org.springframework.boot:spring-boot-starter-security:3.0.5",
        ...
        "org.springframework.boot:spring-boot-devtools:3.0.5",
